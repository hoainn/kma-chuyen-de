"""x86-64 Linux syscall name → number table (kernel 5.x / 6.x)."""
...
SYSCALL_NR: dict[str, int] = {
    ...
    "rt_sigsuspend": 130, "sigaltstack": 131, "utime": 132,
    "mknod": 133, "uselib": 134, "personality": 135,
    "ustat": 136, "statfs": 137, "fstatfs": 138, "sysfs": 139,
    "getpriority": 140, "setpriority": 141, "sched_setparam": 142,
    "sched_getparam": 143, "sched_setscheduler": 144,
    ...
    "_sysctl": 156, "prctl": 157, "arch_prctl": 158,
    ...
    "get_kernel_syms": 177, "query_module": 178, "quotactl": 179,
    "nfsservctl": 180, "getpmsg": 181, "putpmsg": 182, "afs_syscall": 183,
    "tuxcall": 184, "security": 185, "gettid": 186, "readahead": 187,
    "setxattr": 188, "lsetxattr": 189, "fsetxattr": 190,
    ...
    "vserver": 236, "mbind": 237, "set_mempolicy": 238,
    ...
    "pwritev": 296, "rt_tgsigqueueinfo": 297, "perf_event_open": 298,
    "recvmmsg": 299, "fanotify_init": 300, "fanotify_mark": 301,
    "prlimit64": 302, "name_to_handle_at": 303,
    "open_by_handle_at": 304, "clock_adjtime": 305, "syncfs": 306,
    "sendmmsg": 307, "setns": 308, "getcpu": 309,
    ...
    "process_madvise": 440, "epoll_pwait2": 441,
...
NR_SYSCALL: dict[int, str] = {v: k for k, v in SYSCALL_NR.items()}


def name_to_nr(name: str) -> int | None:
    """Strip common kernel prefixes and look up the syscall number."""
    for prefix in ("__x64_sys_", "__arm64_sys_", "__ia32_sys_", "sys_", "__se_sys_", "__do_sys_"):
        if name.startswith(prefix):
            name = name[len(prefix):]
            break
    return SYSCALL_NR.get(name)
