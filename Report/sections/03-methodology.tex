...
Hình~\ref{fig:arch} mô tả kiến trúc ba giai đoạn theo công trình tham chiếu:
(1) lập hồ sơ syscall lai; (2) phát hiện bất thường SyscallAD; (3) thực thi/phản
ứng. Chuyên đề hiện thực hóa trọn vẹn Giai đoạn~2 (lõi phát hiện) và lớp thu
thập/phản ứng của Giai đoạn~1 và 3 bằng Tetragon (cảnh báo, ghi nhật ký); việc chặn
nội tuyến trong nhân để dừng leo thang đặc quyền được nêu là hướng mở rộng.
